...
- 油猴脚本 v2.8 新增 `parseJSONSafe()` 函数，覆盖 `fetchLecture`、`getLectureList`、`appiontCheck`、`queryMyActivityList`、`keepAlive` 五个接口
- CLI `main.py` 新增 `_parse_json()` 工具函数，覆盖 `fetch_lecture`、`check_booking_success`、`get_lecture_list`、`get_code` 四个函数
